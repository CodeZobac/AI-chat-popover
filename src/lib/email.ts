  ...
  return `
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin-bottom: 20px;">
        ...
        <p style="margin: 5px 0 0 0; color: #6b7280;">Your ${
          data.type
      ...
      <p>Thank you for your interest in ETIC Algarve! We have received your ${
        data.type
      ...
      <div style="background-color: #f3f4f6; padding: 15px; border-radius: 6px; margin: 20px 0;">
        ...
        ${
          data.programInterest
            ? `<p><strong>Program Interest:</strong> ${data.programInterest}</p>`
            : ""
        }
        ${
          data.callPurpose
            ? `<p><strong>Call Purpose:</strong> ${data.callPurpose}</p>`
            : ""
        }
        ${
          data.groupSize
      ...
      <p>If you have any questions or need to make changes, please contact us at <a href="mailto:admissions@etic-algarve.com">admissions@etic-algarve.com</a> and reference your confirmation number: <strong>${
...
Thank you for your interest in ETIC Algarve! We have received your ${
    data.type
...
If you have any questions or need to make changes, please contact us at admissions@etic-algarve.com and reference your confirmation number: ${
    data.referenceNumber
  }
  ...
  return `
    ...
    <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
      <div style="background-color: #fef3c7; padding: 20px; border-radius: 8px; margin-bottom: 20px; border-left: 4px solid #f59e0b;">
        <h1 style="color: #92400e; margin: 0;">New ${
          data.type.charAt(0).toUpperCase() + data.type.slice(1)
        } Request</h1>
        <p style="margin: 5px 0 0 0; color: #78350f;">Reference: ${
          data.referenceNumber
        }</p>
      </div>
      ...
      <div style="background-color: #f9fafb; padding: 15px; border-radius: 6px; margin: 15px 0;">
        ...
        <p><strong>Email:</strong> <a href="mailto:${data.contactEmail}">${
    data.contactEmail
  }</a></p>
        ${
          data.contactPhone
            ? `<p><strong>Phone:</strong> <a href="tel:${data.contactPhone}">${data.contactPhone}</a></p>`
            : ""
        }
      </div>
